...
const handleRewritePost = async (postText, options, tone) => {
  ...
  try {
    ...
    if (rewritten) {
      onReplace(rewritten);  // ✅ Send to parent
  ...
  {[
    {
     ...
     desc: "Transforms the draft into a LinkedIn post that sounds just like you — in your tone, structure, and voice.",
      color: "#093FB4",
    }
...
export default RewriteAiDialog;