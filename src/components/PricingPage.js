              ...
              >
                <CardContent>
                  <Typography
                    ...
                    fontWeight={700}
                    mb={1}
                    color={plan === 'pro' ? '#FFFFFF' : 'text.primary'}
                  >
                    {plan === 'starter' ? 'Starter' : 'Pro'}
                  </Typography>

                  <Stack sx={{ display: 'flex', flexDirection: 'row', gap: 1, alignItems: 'end' }}>
                    <Typography mb={1} sx={{ fontFamily: 'Inter', fontSize: '42px', fontWeight: 500, color: plan === 'starter' ? '#000000' : '#FFFFFF' }}>
                      ${pricingData[billing][plan]}
                    </Typography>
                    <Typography mb={3} sx={{ fontFamily: 'Inter', color: 'grey', fontSize: '14px' }}>
                      {billing === 'yearly' ? 'per month' : 'per month'}
                    </Typography>
                  </Stack>
                  ...
                  <Box component="ul" sx={{ pl: 0, mb: 0, listStyle: 'none' }}>
                    ...
                    <Box component="li" display="flex" alignItems="center" mb={1}>
                      ...
                      <Typography
                        variant="body2"
                        sx={{
                          color: plan === 'starter' ? '#000000' : '#ffffff',
                        }}
                      >
                        {plan === 'starter' ? '30 AI Rewrite Credits/month' : '100 AI Rewrite Credits/month'}
                      </Typography>
                    </Box>
                    ...
                    <Box component="li" display="flex" alignItems="center" mb={1}>
                      ...
                      >
                        {plan === 'starter' ? '15 Scheduled Posts/month' : '30 Scheduled Posts/month'}
                      </Typography>
                    </Box>
